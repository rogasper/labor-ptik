...
<!-- Header -->
<div class="header pb-6 d-flex align-items-center" style="min-height: 360px; background-image: url(../../images/lab/computernetwork.jpg); background-size: cover; background-position: center;">
    <!-- Mask -->
