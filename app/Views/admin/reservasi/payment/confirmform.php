        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="justify-content-end" style="display: flex;">
                    <a href="paymentreservasi/<?= $id ?>/cancel" class="btn btn-danger mb-3">Batalkan Sewa</a>
                    <a href="paymentreservasi/<?= $id ?>/confirm" class="btn btn-success mb-3">Konfirmasi Sewa</a>
                </div>
            </div>
        </div>
    </div>
