    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body mt--4">
                <form id="form-fasilitas" action="laboratorium/insert" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="kategori_lab" name="kategori_lab">
                                    ...
                                    <option value="Computer Network and Instrumentation">Computer Network and Instrumentation</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="bootstrap-select" name="fasilitas[]" data-width="100%" data-live-search="true" multiple required>
                        ...
                        <div class="col">
                            <div class="from-group">
                                ...
                                <div class="custom-file">
                                    <label class="custom-file-label" for="file-upload">Select file</label>
