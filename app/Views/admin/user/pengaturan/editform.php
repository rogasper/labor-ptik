                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="civitas" name="civitas">
                                            <option value="1" <?= ($civitas == 1 ? 'selected="selected"' : '') ?>>UNS</option>
                                            <option value="0" <?= ($civitas == 0 ? 'selected="selected"' : '') ?>>NON UNS</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="role" name="role">
                                            ...
                                            <option value="member" <?= ($role == 'member' ? 'selected="selected"' : '') ?>>Member</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="is_verified" name="is_verified">
                                            ...
                                            <option value="0" <?= ($is_verified == 0 ? 'selected="selected"' : '') ?>>Not Verified</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
