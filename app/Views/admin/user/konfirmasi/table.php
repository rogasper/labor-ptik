        ...
        <tbody>
            ...
            foreach ($list as $item) { ?>
                <tr>
                    ...
                    <td class="text-center align-middle">
                        <a href="/admin/userconfirm/<?= $item['username'] ?>/confirm" class="btn bunder text-success" data-toggle="tooltip" data-placement="top" title="Konfirmasi Akun"><i class="fas fa-check"></i></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
