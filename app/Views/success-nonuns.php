...
<div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        ...
                        <p class="text-lead text-white">
                            Silahkan kirim bukti transfer untuk bisa segera dikonfirmasi
                            oleh admin.
                        </p>
                    </div>
                </div>
    ...
    <div class="container mt--9 pb-5">
        ...
        <div class="row">
            <div class="col text-center">
                <a href="https://wa.me/+62895401515612?text=ini+bukti+transfer+saya+untuk+kode+pesanan+<?= $kode ?>" target="__blank" class="btn btn-success px-6">Kirim Bukti Transfer</a>
